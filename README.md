...
:heavy_check_mark: ***Задание №3.1.*** - Выполнено. Находится на проверке-    
:heavy_check_mark: ***Задание №3.2.*** - Выполнено. Находится на проверке-    
:writing_hand: ***Задание №4.1.*** - Выполняется.-    
:clock2: ***Задание №4.2.*** - Ожидает выполнения.-    
